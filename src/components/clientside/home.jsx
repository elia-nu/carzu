      ...
      <main>
        <section className="min-h-full h-fit md:h-[80vh] bg-black/50 bb-12 md:mb-0 flex items-center flex-col justify-center relative">
          <motion.div
            ...
            className="z-10 text-center text-white mb-8 mt-10"
          >
            <h1 className="text-4xl mx-4 md:text-5xl font-bold mb-4">Find Your Perfect Ride</h1>
            <p className="text-md mx-4 md:text-xl mb-8">Discover the freedom of car sharing with carzu</p>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, y: 50 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, delay: 0.2 }}
            className="bg-white rounded-lg p-6 shadow-xl z-10 w-full max-w-4xl mb-12"
          >
            <form onSubmit={handleSearch} className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-4">
            <select name="carType" className="border border-gray-300 rounded-md text-sm p-3 w-full md:w-1/4 focus:outline-none focus:ring-2 focus:ring-red-500">
              ...
              </select>              <input type="date" name="pickupDate" placeholder="Pick-up date" className="border border-gray-300 rounded-md text-sm p-3 w-full md:w-1/4 focus:outline-none focus:ring-2 focus:ring-red-500" />
        ...
        <motion.section
          ...
          animate={{ opacity: 1 }}
          transition={{ duration: 0.8 }}
          className="bg-cover bg-center py-20 mt-12 bg-fixed"
          style={{backgroundImage: "url('https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1920&q=80')"}}
        >
          <div className="container mx-auto px-4">
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8, delay: 0.2 }}
              className="bg-white bg-opacity-90 p-12 rounded-lg text-center"
            >
              <h2 className="text-4xl font-bold mb-4">Share your car, earn extra income</h2>
              <p className="text-xl mb-8">Turn your car into a money-making machine when you're not using it.</p>
